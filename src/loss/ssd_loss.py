...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        for i in range(batch_size):
            ...
            if n_objects != 0: # if there are objects present
            ...
            else: # if there are no objects present
                true_locs[i] = self.priors_cxcy.clone()
                true_classes[i] = torch.zeros(n_priors, dtype=torch.long)
