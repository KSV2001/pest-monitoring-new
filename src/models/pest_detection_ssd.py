...
class Model(pl.LightningModule):
    ...
    def step(self, batch: Any):
        image, gloc_, glabel_, img_ids = batch['imgs'], batch['bbox_coords'], batch['bbox_classes'], batch['img_ids']
    ...
    def training_step(self, batch, batch_idx):
        ...
        output = get_metrics(img_ids = img_ids,
                            ploc = ploc.detach().clone(), plabel = plabel.detach().clone(), gloc = gloc_, glabel = glabel_,
                            img_shape = (300, 300),
                            nms_threshold = 0.5,
                            max_num = 200,
                            iou_threshold = 0.5,
